...
class InclusionExclusion(object):
    ...
    def generateSQL_DNF(self, separatorSubs=None):
        ...
        def collapse_func(red_list,ind=None):
            ...
            if ind == 0:
                if red_list[ind][0] == -1:
                    return "l1sum_n(0," + red_list[ind][1] + ")"
                elif red_list[ind][0] == 1:
                    return "l1diff_n(0," + red_list[ind][1] + ")"
            if red_list[ind][0] == -1:
                return "l1sum_n(" + collapse_func(red_list, ind - 1) + "," + red_list[ind][1] + ")"
            elif red_list[ind][0] == 1:
                return "l1diff_n(" + collapse_func(red_list, ind - 1) + "," + red_list[ind][1] + ")"
